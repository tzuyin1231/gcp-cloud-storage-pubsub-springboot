...
public abstract class PubSubConsumer {
     ...
     * BasicAcknowledgeablePubsubMessage类型的参数，包装了Pub/Sub消息，并提供了消息确认的能力。具体的consumer实现类需要根据自己的需求来实现消息的处理逻辑。
     */
    protected abstract void consume(BasicAcknowledgeablePubsubMessage message) throws IOException;
